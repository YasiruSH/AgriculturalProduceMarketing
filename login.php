...
<!-- Mirrored from tunatheme.com/tf/html/broccoli-preview/broccoli/login.html by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 18 Nov 2022 04:25:57 GMT -->
<head>
    <meta charset="utf-8">
                ...
                <div class="col-lg-12">
                    <div class="ltn__breadcrumb-inner ltn__breadcrumb-inner-2 justify-content-between">
                        <div class="section-title-area ltn__section-title-2">
                            ...
                            <h1 class="section-title white-color">Create Account</h1>
                        </div>
                ...
                <div class="col-lg-6">
                    <div class="account-login-inner">
                        <form method="POST" class="ltn__form-box contact-form-box">
                            <input  type="text" id="email1" placeholder="NIC Number*" name ="nic">
                            <input type="password" id="exampleInputPassword1" placeholder="Password*" name="password">
                            <div class="btn-wrapper mt-0">
                                <button type="submit" class="theme-btn-1 btn btn-block"  name="login">
                                    SIGN IN
                                </button>
                            </div>
        ...
        ?>
                <div class="col-lg-6">
                    <div class="account-create text-center pt-50">
                        ...
                        <p>Please create your accounnt here and  <br>
                        quickly place your orders </p>
