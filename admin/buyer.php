          ...
          <div class="card">
            <div class="card-body">
              ...
              <table class="table table-hover">
                ...
                <?php
            $loop = 1;
                $query = mysqli_query($con, "SELECT * FROM user,role WHERE role.type = 'buyer' AND user.role = role.roleId");
          ...
          <div class="card">
            <div class="card-body">
              ...
              <table class="table table-hover">
                ...
                <?php
                $loop = 1;
                $query = mysqli_query($con, "SELECT * FROM user,boughtitems WHERE user.nic =boughtitems.farmerId");
                if($query){
                    while($row = mysqli_fetch_assoc($query)){
                        echo '
                            <tr>
